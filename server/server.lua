...
RSGCore.Functions.CreateCallback('qc-billing:server:checkbills', function(source, cb, target)
...
RSGCore.Functions.CreateCallback('qc-billing:server:checkSentBills', function(source, cb, citizenid)
    local src = source
...
-- pay bills
RegisterNetEvent('qc-billing:server:paybills', function(data)
...
-- cancel bill
RegisterNetEvent('qc-billing:server:cancelbill', function(billid)
    if Config.Debug == true then
        print(billid)
    end
    local src = source
...
RegisterNetEvent('qc-billing:server:sendSocietyBill', function(playerid, amount, society)
    local src = source
...
RSGCore.Commands.Add("billing", "Opens the Billing Menu", {}, false, function(source)
    local src = source
    TriggerClientEvent('qc-billing:client:billingMenu', src)
end)
